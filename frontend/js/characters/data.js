// File chứa toàn bộ định nghĩa nhân vật
        ...
        skills: [
            {
                key: "q",
                name: "Hồi Máu",
                desc: "Hồi 1 HP (đầy máu thì +10 EXP). (Hồi: 8s)",
                cooldown: 8,
                initialCooldown: 0,
            },
            { key: "e", name: "Tăng tốc", desc: "Tăng tốc nhẹ. (Hồi: 10s)", cooldown: 10 },
            {
                key: "r",
                name: "Cứu Sinh",
                desc: "Hồi 5 HP + choáng & sát thương quái quanh người. (Hồi: 35s)",
                cooldown: 35,
                initialCooldown: 10,
            },
        ],
